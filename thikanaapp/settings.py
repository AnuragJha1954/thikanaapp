"""
Django settings for thikanaapp project.
...
SECRET_KEY = 'django-insecure-^_5&-a!st(l@o&$u0ao8^rl$(m226c8f65)i-2)vkr(ainnrt6'
...
WSGI_APPLICATION = 'thikanaapp.wsgi.application'
